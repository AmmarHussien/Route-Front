...
function CreateAdminForm({ onCloseModal }) {
  ...
  const { addAdmin, isLoading: load } = useCreateAdmin();
  const { isLoading, getRole } = useGetRole();
  ...
  return isLoading || load ? (
    ...
    >
      ...
      <FormRow>
        <Button disabled={isLoading} $size="xlarge">
          {t("Submit")}
        </Button>
      </FormRow>
    </Form>
